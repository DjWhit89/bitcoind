...
\label{classwallet_1_1_c_wallet}\index{CWallet@{CWallet}}
...
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{classwallet_1_1_c_wallet}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
typedef std\+::map$<$ unsigned int, \textbf{ CMaster\+Key} $>$ \textbf{ Master\+Key\+Map}
\item 
...
\item 
using \textbf{ List\+Addr\+Book\+Func} = std\+::function$<$void(const \textbf{ CTx\+Destination}\& dest, const std\+::string\& label, bool is\+\_\+change, const std\+::optional$<$\textbf{ Address\+Purpose}$>$ purpose)$>$
\end{DoxyCompactItemize}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\textbf{ Wallet\+Database} \& \textbf{ Get\+Database} () const override
\item 
const std\+::string \& \textbf{ Get\+Name} () const
\item 
\textbf{ CWallet} (\textbf{ interfaces\+::\+Chain} $\ast$\textbf{ chain}, const std\+::string \&\textbf{ name}, std\+::unique\+\_\+ptr$<$ \textbf{ Wallet\+Database} $>$ database)
\item 
\textbf{ $\sim$\+CWallet} ()
\item 
...
\item 
std\+::map$<$ \textbf{ CTx\+Destination}, \textbf{ CAddress\+Book\+Data} $>$ m\+\_\+address\+\_\+book \textbf{ GUARDED\+\_\+\+BY} (\textbf{ cs\+\_\+wallet})
\item 
const \textbf{ CAddress\+Book\+Data} $\ast$ \textbf{ Find\+Address\+Book\+Entry} (const \textbf{ CTx\+Destination} \&, bool allow\+\_\+change=false) const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
...
\item 
const std\+::unordered\+\_\+map$<$ \textbf{ COut\+Point}, \textbf{ Wallet\+TXO}, \textbf{ Salted\+Outpoint\+Hasher} $>$ \& \textbf{ Get\+TXOs} () const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
std\+::optional$<$ \textbf{ Wallet\+TXO} $>$ \textbf{ Get\+TXO} (const \textbf{ COut\+Point} \&outpoint) const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
...
\begin{DoxyCompactList}\small\item\em Holds a timestamp at which point the wallet is scheduled (externally) to be relocked. Caller must arrange for actual relocking to occur via \doxyref{Lock()}{p.}{classwallet_1_1_c_wallet_a747fd95916e116a6ed37cc641e394c69}. \end{DoxyCompactList}\item 
...
\item 
void \textbf{ Commit\+Transaction} (\textbf{ CTransaction\+Ref} tx, \textbf{ map\+Value\+\_\+t} map\+Value, std\+::vector$<$ std\+::pair$<$ std\+::string, std\+::string $>$ $>$ order\+Form)
\item 
...
\item 
std\+::set$<$ std\+::string $>$ \textbf{ List\+Addr\+Book\+Labels} (const std\+::optional$<$ \textbf{ Address\+Purpose} $>$ purpose) const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
...
\item 
\textbf{ DBErrors} \textbf{ Load\+Wallet} ()
\item 
...
\item 
\textbf{ util\+::\+Result}$<$ void $>$ \textbf{ Remove\+Txs} (\textbf{ Wallet\+Batch} \&batch, std\+::vector$<$ \textbf{ Txid} $>$ \&txs\+\_\+to\+\_\+remove) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
bool \textbf{ Set\+Address\+Book} (const \textbf{ CTx\+Destination} \&address, const std\+::string \&str\+Name, const std\+::optional$<$ \textbf{ Address\+Purpose} $>$ \&purpose)
\item 
bool \textbf{ Del\+Address\+Book} (const \textbf{ CTx\+Destination} \&address)
\item 
bool \textbf{ Del\+Address\+Book\+With\+DB} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CTx\+Destination} \&address)
\item 
...
\item 
bool \textbf{ Set\+Address\+Previously\+Spent} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CTx\+Destination} \&dest, bool used) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
std\+::vector$<$ std\+::string $>$ \textbf{ Get\+Address\+Receive\+Requests} () const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
bool \textbf{ Set\+Address\+Receive\+Request} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CTx\+Destination} \&dest, const std\+::string \&id, const std\+::string \&value) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
bool \textbf{ Erase\+Address\+Receive\+Request} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CTx\+Destination} \&dest, const std\+::string \&id) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
...
\item 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ \textbf{ Get\+Active\+Script\+Pub\+Key\+Mans} () const
...
bool \textbf{ Is\+Active\+Script\+Pub\+Key\+Man} (const \textbf{ Script\+Pub\+Key\+Man} \&spkm) const
\item 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ \textbf{ Get\+All\+Script\+Pub\+Key\+Mans} () const
\begin{DoxyCompactList}\small\item\em Returns all unique Script\+Pub\+Key\+Mans. \end{DoxyCompactList}\item 
\textbf{ Script\+Pub\+Key\+Man} $\ast$ \textbf{ Get\+Script\+Pub\+Key\+Man} (const \textbf{ Output\+Type} \&type, bool internal) const
\begin{DoxyCompactList}\small\item\em Get the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} for the given \doxyref{Output\+Type}{p.}{outputtype_8h_a4e0517338e6c4a31a2addafc06d4f3a3} and internal/external chain. \end{DoxyCompactList}\item 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ \textbf{ Get\+Script\+Pub\+Key\+Mans} (const \textbf{ CScript} \&\textbf{ script}) const
\begin{DoxyCompactList}\small\item\em Get all the Script\+Pub\+Key\+Mans for a script. \end{DoxyCompactList}\item 
\textbf{ Script\+Pub\+Key\+Man} $\ast$ \textbf{ Get\+Script\+Pub\+Key\+Man} (const \textbf{ uint256} \&id) const
\begin{DoxyCompactList}\small\item\em Get the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} by id. \end{DoxyCompactList}\item 
...
\textbf{ Legacy\+Data\+SPKM} $\ast$ \textbf{ Get\+Legacy\+Data\+SPKM} () const
...
\textbf{ Legacy\+Data\+SPKM} $\ast$ \textbf{ Get\+Or\+Create\+Legacy\+Data\+SPKM} ()
\item 
...
bool \textbf{ With\+Encryption\+Key} (std\+::function$<$ bool(const \textbf{ CKeying\+Material} \&)$>$ cb) const override
...
\begin{DoxyCompactList}\small\item\em Connect the signals from Script\+Pub\+Key\+Mans to the signals in \doxyref{CWallet}{p.}{classwallet_1_1_c_wallet}. \end{DoxyCompactList}\item 
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} \& \textbf{ Load\+Descriptor\+Script\+Pub\+Key\+Man} (\textbf{ uint256} id, \textbf{ Wallet\+Descriptor} \&desc)
\begin{DoxyCompactList}\small\item\em Instantiate a descriptor \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} from the \doxyref{Wallet\+Descriptor}{p.}{classwallet_1_1_wallet_descriptor} and load it. \end{DoxyCompactList}\item 
...
\item 
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} \& \textbf{ Setup\+Descriptor\+Script\+Pub\+Key\+Man} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CExt\+Key} \&master\+\_\+key, const \textbf{ Output\+Type} \&output\+\_\+type, bool internal) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\begin{DoxyCompactList}\small\item\em Create new \doxyref{Descriptor\+Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_descriptor_script_pub_key_man} and add it to the wallet. \end{DoxyCompactList}\item 
void \textbf{ Setup\+Descriptor\+Script\+Pub\+Key\+Mans} (\textbf{ Wallet\+Batch} \&batch, const \textbf{ CExt\+Key} \&master\+\_\+key) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
...
\item 
void \textbf{ Setup\+Own\+Descriptor\+Script\+Pub\+Key\+Mans} (\textbf{ Wallet\+Batch} \&batch) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
...
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} $\ast$ \textbf{ Get\+Descriptor\+Script\+Pub\+Key\+Man} (const \textbf{ Wallet\+Descriptor} \&desc) const
\begin{DoxyCompactList}\small\item\em Return the \doxyref{Descriptor\+Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_descriptor_script_pub_key_man} for a \doxyref{Wallet\+Descriptor}{p.}{classwallet_1_1_wallet_descriptor} if it is already in the wallet. \end{DoxyCompactList}\item 
std\+::optional$<$ bool $>$ \textbf{ Is\+Internal\+Script\+Pub\+Key\+Man} (\textbf{ Script\+Pub\+Key\+Man} $\ast$spk\+\_\+man) const
\item 
\textbf{ util\+::\+Result}$<$ std\+::reference\+\_\+wrapper$<$ \textbf{ Descriptor\+Script\+Pub\+Key\+Man} $>$ $>$ \textbf{ Add\+Wallet\+Descriptor} (\textbf{ Wallet\+Descriptor} \&desc, const \textbf{ Flat\+Signing\+Provider} \&signing\+\_\+provider, const std\+::string \&label, bool internal) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\begin{DoxyCompactList}\small\item\em Add a descriptor to the wallet, return a \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} \& associated output type. \end{DoxyCompactList}\item 
bool \textbf{ Migrate\+To\+SQLite} (\textbf{ bilingual\+\_\+str} \&error) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
std\+::optional$<$ \textbf{ Migration\+Data} $>$ \textbf{ Get\+Descriptors\+For\+Legacy} (\textbf{ bilingual\+\_\+str} \&error) const \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\begin{DoxyCompactList}\small\item\em Get all of the descriptors from a legacy wallet. \end{DoxyCompactList}\item 
\textbf{ util\+::\+Result}$<$ void $>$ \textbf{ Apply\+Migration\+Data} (\textbf{ Wallet\+Batch} \&local\+\_\+wallet\+\_\+batch, \textbf{ Migration\+Data} \&data) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(\textbf{ cs\+\_\+wallet})
\item 
...
void \textbf{ Cache\+New\+Script\+Pub\+Keys} (const std\+::set$<$ \textbf{ CScript} $>$ \&spks, \textbf{ Script\+Pub\+Key\+Man} $\ast$spkm)
\begin{DoxyCompactList}\small\item\em Add script\+Pub\+Keys for this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} into the script\+Pub\+Key cache. \end{DoxyCompactList}\item 
void \textbf{ Top\+Up\+Callback} (const std\+::set$<$ \textbf{ CScript} $>$ \&spks, \textbf{ Script\+Pub\+Key\+Man} $\ast$spkm) override
\begin{DoxyCompactList}\small\item\em Callback function for after Top\+Up completes containing any scripts that were added by a SPKMan. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
static std\+::shared\+\_\+ptr$<$ \textbf{ CWallet} $>$ \textbf{ Create} (\textbf{ Wallet\+Context} \&context, const std\+::string \&\textbf{ name}, std\+::unique\+\_\+ptr$<$ \textbf{ Wallet\+Database} $>$ database, uint64\+\_\+t wallet\+\_\+creation\+\_\+flags, \textbf{ bilingual\+\_\+str} \&error, std\+::vector$<$ \textbf{ bilingual\+\_\+str} $>$ \&warnings)
\end{DoxyCompactItemize}
...
\textbf{ Output\+Type} \textbf{ m\+\_\+default\+\_\+address\+\_\+type} \{\textbf{ DEFAULT\+\_\+\+ADDRESS\+\_\+\+TYPE}\}
\item 
std\+::optional$<$ \textbf{ Output\+Type} $>$ \textbf{ m\+\_\+default\+\_\+change\+\_\+type} \{\}
\item 
\textbf{ CAmount} \textbf{ m\+\_\+default\+\_\+max\+\_\+tx\+\_\+fee} \{\textbf{ DEFAULT\+\_\+\+TRANSACTION\+\_\+\+MAXFEE}\}
\item 
...
\item 
boost\+::signals2\+::signal$<$ void(const \textbf{ CTx\+Destination} \&address, const std\+::string \&label, bool is\+Mine, \textbf{ Address\+Purpose} purpose, \textbf{ Change\+Type} status)$>$ \textbf{ Notify\+Address\+Book\+Changed}
\item 
...
A \doxyref{CWallet}{p.}{classwallet_1_1_c_wallet} maintains a set of transactions and balances, and provides the ability to create new transactions. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab088099303fdfded45713af2db4037fb} 
using \textbf{ List\+Addr\+Book\+Func} = std\+::function$<$void(const \textbf{ CTx\+Destination}\& dest, const std\+::string\& label, bool is\+\_\+change, const std\+::optional$<$\textbf{ Address\+Purpose}$>$ purpose)$>$}

Walk-\/through the address book entries. Stops when the provided \textquotesingle{}\doxyref{List\+Addr\+Book\+Func}{p.}{classwallet_1_1_c_wallet_ab088099303fdfded45713af2db4037fb}\textquotesingle{} returns false. \index{CWallet@{CWallet}!MasterKeyMap@{MasterKeyMap}}
\index{MasterKeyMap@{MasterKeyMap}!CWallet@{CWallet}}
\doxysubsubsection{MasterKeyMap}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a17d1aa687d03beac4506d2678e200373} 
typedef std\+::map$<$unsigned int, \textbf{ CMaster\+Key}$>$ \textbf{ Master\+Key\+Map}}

\index{CWallet@{CWallet}!TxItems@{TxItems}}
\index{TxItems@{TxItems}!CWallet@{CWallet}}
\doxysubsubsection{TxItems}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a6c93c8d57d5b988a63b93fa6cd488d8c} 
typedef std\+::multimap$<$int64\+\_\+t, \textbf{ CWallet\+Tx}$\ast$$>$ \textbf{ Tx\+Items}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a160850c1e7624d67567718775aaf3d73} 
using \textbf{ Update\+Wallet\+Tx\+Fn} = std\+::function$<$bool(\textbf{ CWallet\+Tx}\& wtx, bool new\+\_\+tx)$>$}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af0de5ee53ff10ea7bc58cd8cf502fa73} 
\textbf{ CWallet} (\begin{DoxyParamCaption}\item[{\textbf{ interfaces\+::\+Chain} $\ast$}]{chain}{, }\item[{const std\+::string \&}]{name}{, }\item[{std\+::unique\+\_\+ptr$<$ \textbf{ Wallet\+Database} $>$}]{database}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a3bcbda7cf97b5eac4dec2ccae289be33} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ad1048bc3f0c085adf74882f26002ca39} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a12d4a4a3bf39aebea046b8eb4e472483} 
...
Adds the active \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} for the specified type and internal. Writes it to the wallet file 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{in}}  & {\em id} & The unique id for the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} \\
\hline
\mbox{\texttt{in}}  & {\em type} & The \doxyref{Output\+Type}{p.}{outputtype_8h_a4e0517338e6c4a31a2addafc06d4f3a3} this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} provides addresses for \\
\hline
\mbox{\texttt{in}}  & {\em internal} & Whether this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} provides change addresses \\
\hline
\end{DoxyParams}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a0ed89b6d35124fe56a4f13b1a9e54572} 
\textbf{ util\+::\+Result}$<$ std\+::reference\+\_\+wrapper$<$ \textbf{ Descriptor\+Script\+Pub\+Key\+Man} $>$ $>$ Add\+Wallet\+Descriptor (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Descriptor} \&}]{desc}{, }\item[{const \textbf{ Flat\+Signing\+Provider} \&}]{signing\+\_\+provider}{, }\item[{const std\+::string \&}]{label}{, }\item[{bool}]{internal}{}\end{DoxyParamCaption})}



Add a descriptor to the wallet, return a \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} \& associated output type. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2d6d0f8ff87def9d9d865a1521addee3} 
\textbf{ util\+::\+Result}$<$ void $>$ Apply\+Migration\+Data (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{local\+\_\+wallet\+\_\+batch}{, }\item[{\textbf{ Migration\+Data} \&}]{data}{}\end{DoxyParamCaption})}

Adds the Script\+Pub\+Key\+Mans given in \doxyref{Migration\+Data}{p.}{structwallet_1_1_migration_data} to this wallet, removes Legacy\+Script\+Pub\+Key\+Man, and where needed, moves tx and address book entries to watchonly\+\_\+wallet or solvable\+\_\+wallet \index{CWallet@{CWallet}!BackupWallet@{BackupWallet}}
\index{BackupWallet@{BackupWallet}!CWallet@{CWallet}}
\doxysubsubsection{BackupWallet()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aaedbff50a91c14aa1b2cac623b2b595c} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a66958068737b63d53a1b04b39e977cf0} 
void Cache\+New\+Script\+Pub\+Keys (\begin{DoxyParamCaption}\item[{const std\+::set$<$ \textbf{ CScript} $>$ \&}]{spks}{, }\item[{\textbf{ Script\+Pub\+Key\+Man} $\ast$}]{spkm}{}\end{DoxyParamCaption})}



Add script\+Pub\+Keys for this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} into the script\+Pub\+Key cache. 

\index{CWallet@{CWallet}!CanGrindR@{CanGrindR}}
\index{CanGrindR@{CanGrindR}!CWallet@{CWallet}}
\doxysubsubsection{CanGrindR()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a01cf7e800191cb1c505002e3b2dee27b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a1f5907b528877be5bb376b6e2adae077} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ad87a31315d1db7981bcb870972c23e38} 
void Commit\+Transaction (\begin{DoxyParamCaption}\item[{\textbf{ CTransaction\+Ref}}]{tx}{, }\item[{\textbf{ map\+Value\+\_\+t}}]{map\+Value}{, }\item[{std\+::vector$<$ std\+::pair$<$ std\+::string, std\+::string $>$ $>$}]{order\+Form}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a9d8e66b7e1b10865f03af5a1f8331e3f} 
...
For more information see \doxyref{CWallet\+Tx\+::n\+Time\+Smart}{p.}{classwallet_1_1_c_wallet_tx_a4c49d370af578b863cfd5923ecbb3345}, {\texttt{https\+://bitcointalk.\+org/?topic=54527}}, or {\texttt{https\+://github.\+com/bitcoin/bitcoin/pull/1393}}. \index{CWallet@{CWallet}!ConnectScriptPubKeyManNotifiers@{ConnectScriptPubKeyManNotifiers}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a239841167b9f50d3b077c6f22e406cdc} 
...
Remove specified \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} from set of active SPK managers. Writes the change to the wallet file. 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{in}}  & {\em id} & The unique id for the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} \\
\hline
\mbox{\texttt{in}}  & {\em type} & The \doxyref{Output\+Type}{p.}{outputtype_8h_a4e0517338e6c4a31a2addafc06d4f3a3} this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} provides addresses for \\
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_abe8e90b07a5005d8e6442e4d9efed07f} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a960238cac6cb20f4e82363f94626460c} 
bool Del\+Address\+Book\+With\+DB (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CTx\+Destination} \&}]{address}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac32dff38082df7387ddf533070216724} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8e1c7ae181bae4bffd8930dc2ba01102} 
std\+::string Display\+Name (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}

Return wallet name for display, like \doxyref{Log\+Name()}{p.}{classwallet_1_1_c_wallet_aa385db590bc0eed2616a0ea9db5ab946} but translates "{}default wallet"{} string. \index{CWallet@{CWallet}!EraseAddressReceiveRequest@{EraseAddressReceiveRequest}}
\index{EraseAddressReceiveRequest@{EraseAddressReceiveRequest}!CWallet@{CWallet}}
\doxysubsubsection{EraseAddressReceiveRequest()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a9c60d1e4a2d273157ce8b9fec0e885ad} 
bool Erase\+Address\+Receive\+Request (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CTx\+Destination} \&}]{dest}{, }\item[{const std\+::string \&}]{id}{}\end{DoxyParamCaption})}

\index{CWallet@{CWallet}!FillPSBT@{FillPSBT}}
\index{FillPSBT@{FillPSBT}!CWallet@{CWallet}}
\doxysubsubsection{FillPSBT()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a734069327310f3524ccfa901ccb61a09} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ad4493951e4a5fe4e76787823a34761c8} 
const \textbf{ CAddress\+Book\+Data} $\ast$ Find\+Address\+Book\+Entry (\begin{DoxyParamCaption}\item[{const \textbf{ CTx\+Destination} \&}]{dest}{, }\item[{bool}]{allow\+\_\+change}{ = {\ttfamily false}}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2dd078d68c8ef75b1217f6769befdc01} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aca33fd72edba2a2ee56c6c2737dc983d} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a24bb40b37a08f7fee61f4847012bd67e} 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ Get\+Active\+Script\+Pub\+Key\+Mans (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af568eeef5cde2bd4d4ae7b31c3921411} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae978e6134f8e5704070f47d086a59d1b} 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ Get\+All\+Script\+Pub\+Key\+Mans (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_adcfe82b14de8f2298ab229f2bbcc7476} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae7a35eb343e0820b87b68b102864f49a} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab8988e53bad24fcbf1b8ddb4aece5ea0} 
\textbf{ Wallet\+Database} \& Get\+Database (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [override]}, {\ttfamily [virtual]}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a9cb954f08618ec323f938bdf77ad9e8a} 
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} $\ast$ Get\+Descriptor\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{const \textbf{ Wallet\+Descriptor} \&}]{desc}{}\end{DoxyParamCaption}) const}



Return the \doxyref{Descriptor\+Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_descriptor_script_pub_key_man} for a \doxyref{Wallet\+Descriptor}{p.}{classwallet_1_1_wallet_descriptor} if it is already in the wallet. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2a7131e25ec9d466bc321ca08724fc8e} 
std\+::optional$<$ \textbf{ Migration\+Data} $>$ Get\+Descriptors\+For\+Legacy (\begin{DoxyParamCaption}\item[{\textbf{ bilingual\+\_\+str} \&}]{error}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a81f0bce5008b530f1a257c6a0e529f09} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ad544f8dfa6d0fe049b2edb3799d658aa} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae4aae02d86f37feb601da45b8a73c8b1} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a7c5f36c554e29922d6b11a57d49323d1} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_acb89a9268d90671cb9403a77695cbda1} 
\textbf{ Legacy\+Data\+SPKM} $\ast$ Get\+Legacy\+Data\+SPKM (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a55466a39638bb671b24a82941aa37d77} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a66a2b349adf99ad61abe03e503ba3a5a} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_adfd7d630b6063248704b10cfae2e6825} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2ace9aaf5f5886833d8cc346ddd3f027} 
\textbf{ Legacy\+Data\+SPKM} $\ast$ Get\+Or\+Create\+Legacy\+Data\+SPKM (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af39c08c39c6c3267a2b397151ebf9b77} 
\textbf{ Script\+Pub\+Key\+Man} $\ast$ Get\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{const \textbf{ Output\+Type} \&}]{type}{, }\item[{bool}]{internal}{}\end{DoxyParamCaption}) const}



Get the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} for the given \doxyref{Output\+Type}{p.}{outputtype_8h_a4e0517338e6c4a31a2addafc06d4f3a3} and internal/external chain. 

\index{CWallet@{CWallet}!GetScriptPubKeyMan@{GetScriptPubKeyMan}}
\index{GetScriptPubKeyMan@{GetScriptPubKeyMan}!CWallet@{CWallet}}
\doxysubsubsection{GetScriptPubKeyMan()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a84afa1fa32ff87d260c0dfbbef12d145} 
\textbf{ Script\+Pub\+Key\+Man} $\ast$ Get\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{const \textbf{ uint256} \&}]{id}{}\end{DoxyParamCaption}) const}



Get the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} by id. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a0446c2b5da7f63cfe0570d0132f87193} 
std\+::set$<$ \textbf{ Script\+Pub\+Key\+Man} $\ast$ $>$ Get\+Script\+Pub\+Key\+Mans (\begin{DoxyParamCaption}\item[{const \textbf{ CScript} \&}]{script}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aacc3abbc4afa39016beb6cb8690887b1} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a3f7a5206ec854438647566b799b75bb4} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac69675080c605001a50f08888882eded} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a01c6bf8ec9f4e1d3ec3e634035128922} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af00aa17e58b06da8aebe1ab3aa878725} 
std\+::optional$<$ \textbf{ Wallet\+TXO} $>$ Get\+TXO (\begin{DoxyParamCaption}\item[{const \textbf{ COut\+Point} \&}]{outpoint}{}\end{DoxyParamCaption}) const}

\index{CWallet@{CWallet}!GetTXOs@{GetTXOs}}
\index{GetTXOs@{GetTXOs}!CWallet@{CWallet}}
\doxysubsubsection{GetTXOs()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aac64bc8584daabfb5cd1053c8b5ac642} 
const std\+::unordered\+\_\+map$<$ \textbf{ COut\+Point}, \textbf{ Wallet\+TXO}, \textbf{ Salted\+Outpoint\+Hasher} $>$ \& Get\+TXOs (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a1f8c0f9c60ebe70148145d9539ecf6ee} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a018b4f2201779d9749f474b918a68d4c} 
...
Holds a timestamp at which point the wallet is scheduled (externally) to be relocked. Caller must arrange for actual relocking to occur via \doxyref{Lock()}{p.}{classwallet_1_1_c_wallet_a747fd95916e116a6ed37cc641e394c69}. 

\index{CWallet@{CWallet}!GUARDED\_BY@{GUARDED\_BY}}
\index{GUARDED\_BY@{GUARDED\_BY}!CWallet@{CWallet}}
\doxysubsubsection{GUARDED\_BY()\hspace{0.1cm}{\footnotesize\ttfamily [2/5]}}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a104d8a888b3df79b63580eefa1d67109} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a5cd58892264e970c05db83b99427d99d} 
std\+::map$<$ \textbf{ CTx\+Destination}, \textbf{ CAddress\+Book\+Data} $>$ m\+\_\+address\+\_\+book GUARDED\+\_\+\+BY (\begin{DoxyParamCaption}\item[{\textbf{ cs\+\_\+wallet}}]{}{}\end{DoxyParamCaption})}

\index{CWallet@{CWallet}!GUARDED\_BY@{GUARDED\_BY}}
\index{GUARDED\_BY@{GUARDED\_BY}!CWallet@{CWallet}}
\doxysubsubsection{GUARDED\_BY()\hspace{0.1cm}{\footnotesize\ttfamily [4/5]}}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a156ae35fdedf79b34a49faf9cc671c4c} 
...
Map from txid to \doxyref{CWallet\+Tx}{p.}{classwallet_1_1_c_wallet_tx} for all transactions this wallet is interested in, including received and sent transactions. \index{CWallet@{CWallet}!GUARDED\_BY@{GUARDED\_BY}}
\index{GUARDED\_BY@{GUARDED\_BY}!CWallet@{CWallet}}
\doxysubsubsection{GUARDED\_BY()\hspace{0.1cm}{\footnotesize\ttfamily [5/5]}}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a9bd71c72cfe6893b4fc7eecf0c3c7b79} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac7ac1dc9170d774b4dfcf87bc0138e1b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae613c369401f6513e32a069eee4023a3} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aa91eb20a55ac482526f10351db0c47fe} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae24c5c694bc55ca31175b90fde59f5e2} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac47270ae850ee23706d699701f102d25} 
bool Is\+Active\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{const \textbf{ Script\+Pub\+Key\+Man} \&}]{spkm}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a6bf473dec5c080d6418f1a80542be188} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a052e358d44d29074784be6fb57a7d06f} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a046bec6756ca55d8fb375f2b174ea69e} 
std\+::optional$<$ bool $>$ Is\+Internal\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{\textbf{ Script\+Pub\+Key\+Man} $\ast$}]{spk\+\_\+man}{}\end{DoxyParamCaption}) const}

Returns whether the provided \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} is internal 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{in}}  & {\em spk\+\_\+man} & The \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} to test \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
contains value only for active \doxyref{Descriptor\+Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_descriptor_script_pub_key_man}, otherwise undefined 
\end{DoxyReturn}
\index{CWallet@{CWallet}!IsLocked@{IsLocked}}
\index{IsLocked@{IsLocked}!CWallet@{CWallet}}
\doxysubsubsection{IsLocked()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae2da09e4c159fa756de98a82eef53fff} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a3aab9bc2e11bbeec847e19eafff2c9d2} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a90202be35a4a6a81d447fb288e73f00a} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af65d5de8f70a62c6985f149ca9d088e9} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a5af4dabf48f7115ad92e38b0bcf9e5f2} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a543b23fc38cee37e44d7a3ba1209c6cc} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8e8b197d1cebeb2a76318ccbd317066b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8ac1986ddd18f71dff3f7e0594cd4160} 
std\+::set$<$ std\+::string $>$ List\+Addr\+Book\+Labels (\begin{DoxyParamCaption}\item[{const std\+::optional$<$ \textbf{ Address\+Purpose} $>$}]{purpose}{}\end{DoxyParamCaption}) const}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aa682905b4cd7a27f9da221debe60407e} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a10143ba1c0a65f839411f7b4e5280e39} 
...
Loads an active \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} for the specified type and internal. (used by Load\+Wallet) 
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{in}}  & {\em id} & The unique id for the \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} \\
\hline
\mbox{\texttt{in}}  & {\em type} & The \doxyref{Output\+Type}{p.}{outputtype_8h_a4e0517338e6c4a31a2addafc06d4f3a3} this \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} provides addresses for \\
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2c70fb1c7967a97c18c5cc0c4663af36} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a65346421da77b95ac454e24559f4994e} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab7241f8831a3b878f4a11aa6c91ba80a} 
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} \& Load\+Descriptor\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{\textbf{ uint256}}]{id}{, }\item[{\textbf{ Wallet\+Descriptor} \&}]{desc}{}\end{DoxyParamCaption})}



Instantiate a descriptor \doxyref{Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_script_pub_key_man} from the \doxyref{Wallet\+Descriptor}{p.}{classwallet_1_1_wallet_descriptor} and load it. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac52d0c4c4aeb443b9c877c9b585cb523} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a0f26754363eb38ed45aa44e9781409fe} 
\textbf{ DBErrors} Load\+Wallet (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}

\index{CWallet@{CWallet}!Lock@{Lock}}
\index{Lock@{Lock}!CWallet@{CWallet}}
\doxysubsubsection{Lock()}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a747fd95916e116a6ed37cc641e394c69} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aafce10897dd88084f60c277836bf8439} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aa385db590bc0eed2616a0ea9db5ab946} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_afc165a4df3ac5278937028376f04f011} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a9ab4ad1f8f8170dfd2635a3c5b7ea13c} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_afe4abb209a471081ebcbdb43d6d3f083} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a80fbef7fd4f9421632b4221ae5608dd3} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a61bbd97a401e6a9a00311d41548fbb8f} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a6be6d6a31222c9e29af17687341a255b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab576f27d87d1c19d311d3f7537e88865} 
\textbf{ util\+::\+Result}$<$ void $>$ Remove\+Txs (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{std\+::vector$<$ \textbf{ Txid} $>$ \&}]{txs\+\_\+to\+\_\+remove}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a3855a7cd3860207e699caa5e3c68efd0} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a5621196430a699dd10d59bc9e236b071} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a3fd036c5725be1ffab80b54b0a20dad5} 
bool Set\+Address\+Book (\begin{DoxyParamCaption}\item[{const \textbf{ CTx\+Destination} \&}]{address}{, }\item[{const std\+::string \&}]{str\+Name}{, }\item[{const std\+::optional$<$ \textbf{ Address\+Purpose} $>$ \&}]{purpose}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af6bcc8943d5cdb92fc8911f6281afd18} 
bool Set\+Address\+Previously\+Spent (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CTx\+Destination} \&}]{dest}{, }\item[{bool}]{used}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a651115338c4bcec1c8a311218ea4d849} 
bool Set\+Address\+Receive\+Request (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CTx\+Destination} \&}]{dest}{, }\item[{const std\+::string \&}]{id}{, }\item[{const std\+::string \&}]{value}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a554e9646017278a96994a73a739bc410} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a5370c00fa1971e834f6219c6aba1f6fc} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aedc47a732a577a61d47a9769e943967f} 
\textbf{ Descriptor\+Script\+Pub\+Key\+Man} \& Setup\+Descriptor\+Script\+Pub\+Key\+Man (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CExt\+Key} \&}]{master\+\_\+key}{, }\item[{const \textbf{ Output\+Type} \&}]{output\+\_\+type}{, }\item[{bool}]{internal}{}\end{DoxyParamCaption})}



Create new \doxyref{Descriptor\+Script\+Pub\+Key\+Man}{p.}{classwallet_1_1_descriptor_script_pub_key_man} and add it to the wallet. 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a0914db7e21654e8cd140d5b7a5df3573} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a06475a310bfaed171630e5903374375b} 
void Setup\+Descriptor\+Script\+Pub\+Key\+Mans (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{, }\item[{const \textbf{ CExt\+Key} \&}]{master\+\_\+key}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a42e7171b6364ff12e3f2b81b5b84cc94} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_adbe4e3ca74af3a85f21caf43c8b71c02} 
void Setup\+Own\+Descriptor\+Script\+Pub\+Key\+Mans (\begin{DoxyParamCaption}\item[{\textbf{ Wallet\+Batch} \&}]{batch}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a42dea9d4afe23b378ce40712d431e154} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_aa8bc87176f5112fb747680c3f449083d} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a872f79a2f644abe28af2108119b6a01b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a093c331dde7347a38872f3e43936d939} 
void Top\+Up\+Callback (\begin{DoxyParamCaption}\item[{const std\+::set$<$ \textbf{ CScript} $>$ \&}]{}{, }\item[{\textbf{ Script\+Pub\+Key\+Man} $\ast$}]{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
Implements \textbf{ Wallet\+Storage} \doxyref{}{p.}{classwallet_1_1_wallet_storage_a66367c3f76bf794ccb5e1afd4562b4eb}.
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a7b7dda1afc261b6e0f25fe554990ca4e} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a075a1d14681e61ebbe4669a20de165cf} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a11db7a247cf82b02679ad3b9ff077074} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a85a9c76561eb52deb1ef3e1bcf1101e9} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab231740b5fcabd8da3c6eda6cf1cfd06} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a5ffa05f033f466c0ee78c740a3ddc7db} 
bool With\+Encryption\+Key (\begin{DoxyParamCaption}\item[{std\+::function$<$ bool(const \textbf{ CKeying\+Material} \&)$>$}]{cb}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
Implements \textbf{ Wallet\+Storage} \doxyref{}{p.}{classwallet_1_1_wallet_storage_a9b8c7098575cc9f46dd4659567da323c}.
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8ecbd65706f18505307d222e2b1e520f} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_add744ad51ccb588bc7e404cf0ab3d77e} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a923b5c6bdb86562f8e91dbecb2eaf6a1} 
\textbf{ Recursive\+Mutex} cs\+\_\+wallet\hspace{0.3cm}{\ttfamily [mutable]}}

Main wallet lock. This lock protects all the fields added by \doxyref{CWallet}{p.}{classwallet_1_1_c_wallet}. \index{CWallet@{CWallet}!m\_allow\_fallback\_fee@{m\_allow\_fallback\_fee}}
\index{m\_allow\_fallback\_fee@{m\_allow\_fallback\_fee}!CWallet@{CWallet}}
\doxysubsubsection{m\_allow\_fallback\_fee}
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8abebc10a356260c20c78753c7e39895} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_accd1a3b8612ecc7991bf7d47841a0f67} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a952e803e8113ec49ed3d3edb30a989a5} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_abeb7a55de7b481ea67770dade613bbd3} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac3607758a2a270a215b1af018977e828} 
\textbf{ Output\+Type} m\+\_\+default\+\_\+address\+\_\+type \{\textbf{ DEFAULT\+\_\+\+ADDRESS\+\_\+\+TYPE}\}}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a91ccd20ccc280820ea4d9a3600ff2959} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a2cca81e2fd4a628073ac959cf3a24d82} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_adb8e3a53f42c0025ee1364486a76a251} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a991ff968afce9be4d74da0c01a4322d0} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a8e322b589d52e7c3396880cf46ec0aac} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a65b2dcca5c8a23bcd65c2bf8bda552e0} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a61c1187becd7d4751e83704c749c5315} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac66b7a1989f5ffc39523887153141ffc} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ade3e7a21e4e1fce7a28269d8bd9edbcb} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a4f0685c16116a40bff01d284556f4f7f} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ae44bd556be5ee9d50d0104935c029281} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_acd187867ecbf213198f6deb79f8ca0c8} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_afa8f785043098bea4bed47fe9be01bd8} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ad756f492b82b8402023224a2af26ff11} 
boost\+::signals2\+::signal$<$void(const \textbf{ CTx\+Destination}\& address, const std\+::string\& label, bool is\+Mine, \textbf{ Address\+Purpose} purpose, \textbf{ Change\+Type} status)$>$ Notify\+Address\+Book\+Changed}
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a909c982de74e0eb5c51f57b161ae6352} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab98dd8ac2afc8846cca32c6d2a368984} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_af0438e3e4c388c32d9780aea830231e9} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ac048f4a1feba4e42ed106b2ea6cd9e6b} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_a6abd6d9bb196b68480bbaf59c3d01870} 
...
{\footnotesize\ttfamily \label{classwallet_1_1_c_wallet_ab270a4be824cbeb43426ba9054648166} 
