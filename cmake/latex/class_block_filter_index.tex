\doxysection{Block\+Filter\+Index Class Reference}
\label{class_block_filter_index}\index{BlockFilterIndex@{BlockFilterIndex}}


{\ttfamily \#include $<$blockfilterindex.\+h$>$}

Inheritance diagram for Block\+Filter\+Index\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{class_block_filter_index}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\textbf{ Block\+Filter\+Index} (std\+::unique\+\_\+ptr$<$ \textbf{ interfaces\+::\+Chain} $>$ chain, \textbf{ Block\+Filter\+Type} filter\+\_\+type, size\+\_\+t n\+\_\+cache\+\_\+size, bool f\+\_\+memory=false, bool f\+\_\+wipe=false)
\item 
\textbf{ Block\+Filter\+Type} \textbf{ Get\+Filter\+Type} () const
\item 
bool \textbf{ Lookup\+Filter} (const \textbf{ CBlock\+Index} $\ast$block\+\_\+index, \textbf{ Block\+Filter} \&filter\+\_\+out) const
\item 
bool \textbf{ Lookup\+Filter\+Header} (const \textbf{ CBlock\+Index} $\ast$block\+\_\+index, \textbf{ uint256} \&header\+\_\+out) \textbf{ EXCLUSIVE\+\_\+\+LOCKS\+\_\+\+REQUIRED}(!m\+\_\+cs\+\_\+headers\+\_\+cache)
\item 
bool \textbf{ Lookup\+Filter\+Range} (int start\+\_\+height, const \textbf{ CBlock\+Index} $\ast$stop\+\_\+index, std\+::vector$<$ \textbf{ Block\+Filter} $>$ \&filters\+\_\+out) const
\item 
bool \textbf{ Lookup\+Filter\+Hash\+Range} (int start\+\_\+height, const \textbf{ CBlock\+Index} $\ast$stop\+\_\+index, std\+::vector$<$ \textbf{ uint256} $>$ \&hashes\+\_\+out) const
...
\textbf{ Base\+Index\+::\+DB} \& \textbf{ Get\+DB} () const \textbf{ LIFETIMEBOUND} override
\end{DoxyCompactItemize}
...
\doxyref{Block\+Filter\+Index}{p.}{class_block_filter_index} is used to store and retrieve block filters, hashes, and headers for a range of blocks by height. An index is constructed for each supported filter type with its own database (ie. filter data for different types are stored in separate databases).

This index is used to serve BIP 157 net requests. 

\label{doc-constructors}
\doxysubsection{Constructor \& Destructor Documentation}
\index{BlockFilterIndex@{BlockFilterIndex}!BlockFilterIndex@{BlockFilterIndex}}
\index{BlockFilterIndex@{BlockFilterIndex}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{BlockFilterIndex()}
{\footnotesize\ttfamily \label{class_block_filter_index_ac7c7ac878e8298c700887b76c1a73c69} 
\textbf{ Block\+Filter\+Index} (\begin{DoxyParamCaption}\item[{std\+::unique\+\_\+ptr$<$ \textbf{ interfaces\+::\+Chain} $>$}]{chain}{, }\item[{\textbf{ Block\+Filter\+Type}}]{filter\+\_\+type}{, }\item[{size\+\_\+t}]{n\+\_\+cache\+\_\+size}{, }\item[{bool}]{f\+\_\+memory}{ = {\ttfamily false}, }\item[{bool}]{f\+\_\+wipe}{ = {\ttfamily false}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [explicit]}}

Constructs the index, which becomes available to be queried. 

\label{doc-func-members}
\doxysubsection{Member Function Documentation}
\index{BlockFilterIndex@{BlockFilterIndex}!CustomAppend@{CustomAppend}}
\index{CustomAppend@{CustomAppend}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{CustomAppend()}
{\footnotesize\ttfamily \label{class_block_filter_index_a2866130d78abde86682621008c9b0ca3} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!CustomCommit@{CustomCommit}}
\index{CustomCommit@{CustomCommit}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{CustomCommit()}
{\footnotesize\ttfamily \label{class_block_filter_index_ad0cef080d295f0162f68530a8e44575e} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!CustomInit@{CustomInit}}
\index{CustomInit@{CustomInit}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{CustomInit()}
{\footnotesize\ttfamily \label{class_block_filter_index_a152681603ac9fb8c0ccbf84efaa56da9} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!CustomOptions@{CustomOptions}}
\index{CustomOptions@{CustomOptions}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{CustomOptions()}
{\footnotesize\ttfamily \label{class_block_filter_index_a51d997d6ac9091245a102cfad7db925d} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!CustomRemove@{CustomRemove}}
\index{CustomRemove@{CustomRemove}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{CustomRemove()}
{\footnotesize\ttfamily \label{class_block_filter_index_aa40d547c510f155772c2748cfb675765} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!GetDB@{GetDB}}
\index{GetDB@{GetDB}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{GetDB()}
{\footnotesize\ttfamily \label{class_block_filter_index_a08f644c9774cc50263e2a5c60c8a1c5b} 
...
\index{BlockFilterIndex@{BlockFilterIndex}!GetFilterType@{GetFilterType}}
\index{GetFilterType@{GetFilterType}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{GetFilterType()}
{\footnotesize\ttfamily \label{class_block_filter_index_aa3b2667a0cc35eaf1ff4f024f92bdce3} 
\textbf{ Block\+Filter\+Type} Get\+Filter\+Type (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}

\index{BlockFilterIndex@{BlockFilterIndex}!LookupFilter@{LookupFilter}}
\index{LookupFilter@{LookupFilter}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{LookupFilter()}
{\footnotesize\ttfamily \label{class_block_filter_index_ad6c918d5e03b06dff7c3e98f4b5376d5} 
bool Lookup\+Filter (\begin{DoxyParamCaption}\item[{const \textbf{ CBlock\+Index} $\ast$}]{block\+\_\+index}{, }\item[{\textbf{ Block\+Filter} \&}]{filter\+\_\+out}{}\end{DoxyParamCaption}) const}

Get a single filter by block. \index{BlockFilterIndex@{BlockFilterIndex}!LookupFilterHashRange@{LookupFilterHashRange}}
\index{LookupFilterHashRange@{LookupFilterHashRange}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{LookupFilterHashRange()}
{\footnotesize\ttfamily \label{class_block_filter_index_a5b477dbe22cb72cbff33c42a358b867b} 
bool Lookup\+Filter\+Hash\+Range (\begin{DoxyParamCaption}\item[{int}]{start\+\_\+height}{, }\item[{const \textbf{ CBlock\+Index} $\ast$}]{stop\+\_\+index}{, }\item[{std\+::vector$<$ \textbf{ uint256} $>$ \&}]{hashes\+\_\+out}{}\end{DoxyParamCaption}) const}

Get a range of filter hashes between two heights on a chain. \index{BlockFilterIndex@{BlockFilterIndex}!LookupFilterHeader@{LookupFilterHeader}}
\index{LookupFilterHeader@{LookupFilterHeader}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{LookupFilterHeader()}
{\footnotesize\ttfamily \label{class_block_filter_index_acfdddc9ce6b0ff5c2082815ca526977f} 
bool Lookup\+Filter\+Header (\begin{DoxyParamCaption}\item[{const \textbf{ CBlock\+Index} $\ast$}]{block\+\_\+index}{, }\item[{\textbf{ uint256} \&}]{header\+\_\+out}{}\end{DoxyParamCaption})}

Get a single filter header by block. \index{BlockFilterIndex@{BlockFilterIndex}!LookupFilterRange@{LookupFilterRange}}
\index{LookupFilterRange@{LookupFilterRange}!BlockFilterIndex@{BlockFilterIndex}}
\doxysubsubsection{LookupFilterRange()}
{\footnotesize\ttfamily \label{class_block_filter_index_a3b76396ced514ecf4807816bc5900e53} 
bool Lookup\+Filter\+Range (\begin{DoxyParamCaption}\item[{int}]{start\+\_\+height}{, }\item[{const \textbf{ CBlock\+Index} $\ast$}]{stop\+\_\+index}{, }\item[{std\+::vector$<$ \textbf{ Block\+Filter} $>$ \&}]{filters\+\_\+out}{}\end{DoxyParamCaption}) const}

Get a range of filters between two heights on a chain. 

The documentation for this class was generated from the following files\+:\begin{DoxyCompactItemize}
\item 
src/index/\textbf{ blockfilterindex.\+h}\item 
src/index/\textbf{ blockfilterindex.\+cpp}\end{DoxyCompactItemize}
